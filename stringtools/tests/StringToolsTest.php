...
final class StringToolsTest extends TestCase
{
    ...
    {
        $stringToul = new StringTools(' string');
    ...
    {
        $stringToul = new StringTools('teststring');
    ...
    {
        $this->assertEquals('string', StringTools::concat('str', 'ing'));
    }

    public function testConcatenate()
    {
        $this->assertEquals('string', StringTools::concatenate('st', 'ri', 'ng'));
    }

    public function testReplace()
    {
        $this->assertEquals('sporring', StringTools::replace('t', 'por', 'string'));
    }
}